...
call-shuttle-command-description = Calls the train with an optionally provided arrival time.
call-shuttle-command-help-text = Usage: {$command} [m:ss]
# recall-shuttle-command-description = Recalls the emergency shuttle.
recall-shuttle-command-description = Stops the train from coming and extends the round timer.
