...
{
    [RegisterComponent, Access(typeof(BloodstreamSystem), typeof(ReactionMixerSystem), typeof(BloodDeficiencySystem), typeof(HemophiliaSystem), typeof(Content.Server._Misfits.Genetics.Abilities.BleedingMutationSystem))]
