...
using Content.Server._Misfits.NPC.Components; // #Misfit Add: new comp PathfindingCustomizableComponent
        ...
        public override void Update(float frameTime)
        {
            ...
            Parallel.For(0, amount, options, i =>
            {
                ...
                try
                {
                    switch (request)
                    {
                        /// Misfit Change: where <see cref="PathfindingSystem.UpdateAStarCustomPath"/> is coupled to
                        /// <see cref="AStarCustomPathRequest"/> is returned from <see cref="GetRequest"/>
