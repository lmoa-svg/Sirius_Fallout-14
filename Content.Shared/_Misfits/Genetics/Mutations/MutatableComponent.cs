...
public sealed partial class MutatableComponent : Component
{
    ...
    /// <summary>
    /// Genetics-owned DNA sequence. The target fork's forensic DNA component is server-only,
    /// so this networked value is the portable source of truth for mutation sequencing.
    /// </summary>
    [DataField, AutoNetworkedField]
    public string GeneticDna = string.Empty;
    ...
    /// </summary>
    [DataField]
    public string MeltingEffect = "DnaMelting";
